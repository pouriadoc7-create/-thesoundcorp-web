  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        <span className="text-[10px] font-medium uppercase tracking-[0.18em] text-muted xl:text-[11px]">
        ...
        <span className="mt-3 text-[12px] text-muted xl:text-sm">{product.priceNote}</span>
      </div>
    </Link>
  );
}
